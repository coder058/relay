...
export function JobDesk() {
  ...
  return <div className="job-desk">
    ...
    <main className="desk-main">
      ...
      {report && <section className="desk-panel evidence-panel" aria-label="Evidence results"><div className="panel-heading"><div><h2>Requirement evidence</h2><p>Reviewed {date(report.reviewed_at)} · No eligibility decision or application submitted.</p></div><button className="desk-button" disabled={working} onClick={() => void exportMarkdown()}><ArrowDownToLine size={16} />Export Markdown</button></div>
